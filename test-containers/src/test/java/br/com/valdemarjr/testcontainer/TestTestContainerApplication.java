package br.com.valdemarjr.testcontainer;
...
public class TestTestContainerApplication {
  ...
  public static void main(String[] args) {
    SpringApplication.from(TestContainerApplication::main)
        .with(TestTestContainerApplication.class)
        .run(args);
  }

  @Bean
  @RestartScope
  // springboot-devtools must be in test scope. This annotation will keep the container up and
  // running even if the application restarts
  @ServiceConnection
  ...
  static GenericContainer container =
      new GenericContainer(DockerImageName.parse("myImage/myImage"))
